      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 space-y-8 text-gray-600 leading-relaxed">
          ...
          <section>
            ...
            <p>Настоящий документ является публичной офертой ИП Елисеевой Валерии Николаевны (далее — «Продавец») и содержит условия заключения договора купли-продажи товаров (цветочных композиций, букетов) с доставкой через сайт <strong>floree.ru</strong>.</p>
          ...
          <section>
            ...
            <p className="mt-3">При обнаружении существенных недостатков товара Покупатель вправе предъявить претензию в течение 24 часов с момента получения, связавшись с Продавцом по телефону <a href="tel:+79930750577" className="text-rose-500 underline">+7 993 075 05 77</a>.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">Отмена заказа возможна до момента передачи заказа в доставку. Для отмены свяжитесь с нами по телефону +7 993 075 05 77.</p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              Телефон: <a href="tel:+79930750577" className="text-rose-500 underline">+7 993 075 05 77</a><br />
              Сайт: floree.ru
            </p>
          </section>
        </div>
